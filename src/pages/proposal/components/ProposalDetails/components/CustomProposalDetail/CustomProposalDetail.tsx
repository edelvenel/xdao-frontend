...
interface ICustomProposalDetailProps {
	proposal: IProposal;
	onVote: () => void;
}

export function CustomProposalDetail({ proposal, onVote }: ICustomProposalDetailProps) {
		...
		>
			<div className={css.page}>
				...
				<div className={css.card}>
					...
					<div className={css.block}>
						<div className={css.column}>
							<div className={css.label}>Options</div>
							<div className={css.value}>Yes/No</div>
						</div>
					</div>

					<div className={css.block}>
						<div className={css.column}>
							<div className={css.label}>Token type</div>
							<div className={css.value}>LP</div>
						</div>
					</div>
					<div className={css.block}>
						<div className={css.column}>
